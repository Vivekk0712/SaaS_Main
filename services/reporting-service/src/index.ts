...
async function bootstrap() {
  ...
  app.get('/v1/admin/analytics/class/:id', (req, res) => res.status(501).json({ error: 'not_implemented', id: req.params.id }));
  ...
  const server = app.listen(PORT, () => logger.info('Reporting service started', { port: PORT }));
