...
export default function HODDatabaseChatPage() {
  ...
  const exampleQuestions = [
    ...
    "Show me attendance statistics for CLASS 1 this month",
    "What's the fee summary for CLASS 10?",
    "Show me class performance in Mathematics",
    "List all calendar events this week",
    "Show me recent circulars",
    "What marks did students get in the last test?",
    "Show me parent information for student USN 2024001",
  ]

  return (
    <div className="page">
      {/* Modern Header with HOD Gradient */}
      <nav style={{
      ...
      <main style={{
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          <p style={{
            ...
            Advanced database queries with full school access. Ask about any data across all classes, teachers, and departments.
          </p>
        </div>
        ...
        <div style={{
            ...
            {messages.length === 0 ? (
              <div style={{
                ...
                <p style={{ marginBottom: '24px', maxWidth: '500px' }}>
                  You have full access to all school data. Ask me anything about students, teachers, performance, attendance, and more.
                </p>
                <div style={{
                  display: 'grid',
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: '12px', alignItems: 'flex-end' }}>
              <div style={{ flex: 1, position: 'relative' }}>
                <textarea
                  ...
                  placeholder="Ask about school-wide data, performance analytics, teacher reports... (Press Enter to send)"
                  rows={1}
                  disabled={loading}
                  style={{
                    width: '100%',
            ...
            <div style={{
              ...
              <span>👨‍💼</span>
              <span>HOD Access: Full school data • Press Enter to send • Shift+Enter for new line</span>
            </div>
          </div>
        </div>
      </main>
